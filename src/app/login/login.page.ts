...
export class LoginPage implements OnInit {
    ...
    ngOnInit() {
        ...
        this.mobileLandScreen =
            this.platform.is('mobile') && (this.platform.is('ios') || this.platform.is('android')) && showNativeAppSuggestion;
        ...
        this.subscriptions.push(
            this.translatorServ.acceptRequest(this.inviteToken, translator).subscribe(
                ...
                (err) => {
                    ...
                    if (
                        (this.translatorAcceptError && this.translatorAcceptError.name === 'ERROR_INVITE_ACCEPTED') ||
